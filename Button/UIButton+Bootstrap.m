...
-(void)primaryStyle{
    [self bootstrapStyle];
    self.backgroundColor = [UIColor colorWithRed:15./255. green:149./255. blue:216./255. alpha:1];
    self.layer.borderWidth = 0.;
    //self.layer.borderColor = [[UIColor colorWithRed:15./255. green:149./255. blue:216./255. alpha:0.8] CGColor];
...
-(void)myStyle1{
    [self bootstrapStyle];
    self.backgroundColor = [UIColor colorWithRed:39./255. green:47./255. blue:66./255. alpha:1.];
    self.layer.borderWidth = 0.;
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithRed:69/255.0 green:164/255.0 blue:84/255.0 alpha:1]] forState:UIControlStateHighlighted];
}
